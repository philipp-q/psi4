...
#TRIAL# uncommented philipp-q
    @staticmethod
    def pyconstruct_combined(mol, keys, targets, fitroles, others, returnDict=True):  # philipp-q: add returnDict
        ...
        if isinstance(mol, str): ## philpp-q was basestring inst of string
            mol = Molecule(mol)
        ...
        # philipp-q: overwrite returnBasisSet if returnDict==True
        returnBasisSet = False if returnDict == True else returnBasisSet
